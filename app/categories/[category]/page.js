    ...
    <div>
        <section> 
            <div className="px-8 pb-12 mx-auto max-w-7xl md:px-12 lg:pb-24 pt-36"> 
                <h1 className="text-3xl md:text-5xl lg:text-7xl text-balance">
                ...
                <div className="flex flex-wrap gap-2 mt-6"> 
                    ...
                    <a href="" title="link to your page" aria-label="your label" className="items-center text-sm active:bg-gray-100 h-12 active:text-gray-900/60 active:transition-none border font-medium gap-2 inline-flex justify-center outline-offset-2 px-6 py-3 transition w-full bg-white hover:bg-gray-50 lg:w-auto rounded-lg border-gray-200">Buy SuperStore
                    </a> 
                </div>
            </div> 
        </section> 
            <div className="px-8 py-12 mx-auto max-w-7xl md:px-12"> 
                <div className="border-b border-gray-200 pb-5"> 
                    <h3 className="text-base font-semibold">Our phone cases</h3> 
                </div> 
                <div className="grid md:grid-cols-2 lg:grid-cols-4 mt-12 gap-2 gap-y-12 lg:gap-y-24"> 
        {categoryProducts.map((product) => (
            <Link key={product.id} href={`/categories/${product.category}/${product.id}`} className="group relative border bg-white rounded-xl text-black overflow-hidden border-gray-200"> 
