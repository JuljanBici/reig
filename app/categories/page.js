                ...
                <div className="px-8 py-12 mx-auto max-w-7xl md:px-12">
                    ...
                    <>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 mt-12 gap-2 gap-y-12 lg:gap-y-24">
                            {items.map((product) => (
                            <Link key={product.id} href={`/categories/${product.category}/${product.id}`} className="group relative border bg-white text-black rounded-xl overflow-hidden border-gray-200"> 
